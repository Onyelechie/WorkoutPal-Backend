...
|Kurt|[Routine Scheduler](https://github.com/Onyelechie/WorkoutPal-Frontend/pull/78)|Built the [routine scheduler](https://github.com/Onyelechie/WorkoutPal-Frontend/tree/main/src/components/Workouts/Routines/RoutineScheduler) and created [backend domain interfaces](https://github.com/Onyelechie/WorkoutPal-Backend/commit/6918e7dd1ef87b6ccde7f41470e63229a3a254a2) for Max to finish. This is so that we can work simultaneously where I set up the frontend's routine scheduler for API endpoints that don't exist yet, increasing efficiency.| 
|Max|[Backend / API](https://github.com/Onyelechie/WorkoutPal-Backend/pull/33)|Wrote request handlers, service logic, SQL query and DB executions for a variety of CRUD endpoints including posts and achievements alongside unit tests for each layer. Added a [new error response](https://github.com/Onyelechie/WorkoutPal-Backend/pull/37) object which provides a more detailed account of what went wrong.|
